package com.sawrose.movielist.features.animate
...
import com.sawrose.movielist.core.extension.cancelTransition
...
class MovieDetailsAnimator @Inject constructor() {
    ...
    internal fun fadeVisible(viewContainer: ViewGroup, view: View) = beginTransitionFor(
